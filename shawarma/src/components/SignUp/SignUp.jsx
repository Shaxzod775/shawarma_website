...
const SignUpModal = ({ isOpen, onClose }) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
          const response = await axios.post('https://shawarma.space/api/accounts/register/', {
          ...
          if (message === 'User logged in successfully.') {
            ...
            const response_token = await axios.post('https://shawarma.space/api/accounts/token/', {
              phone:formData.phoneNumber,
              password:formData.password
            });
