...
const MyInfoModal = ({ isOpen, onClose }) => {
      ...
      const handleSubmit = async (event) => {
        ...
        try {
            ...
            if (!fullname.trim() && formData.fullname.trim()) {
                await axios.post('https://shawarma.space/api/accounts/user/fullname/', bodyFullname, config);
            } else if (formData.fullname !== fullname) {
                await axios.put('https://shawarma.space/api/accounts/user/fullname/', bodyFullname, config);
            }
    
            if (!address.trim() && formData.address.trim()) {
                await axios.post('https://shawarma.space/api/accounts/user/address/', bodyAdress, config);
    ...
    const getAddress = async () => {
      ...
      try {
        const response = await axios.get('https://shawarma.space/api/accounts/user/address/', config);
    ...
    const getFullname = async () => {
      ...
      try {
        const response = await axios.get('https://shawarma.space/api/accounts/user/fullname/', config);
