...
const OrderDetail = () => {
  ...
  const getOrderDetails = async () => {
    ...
    try {
      const response = await axios.get('https://shawarma.space/api/orders/order/', config);  
  ...
  const getAddress = async () => {
    ...
    try {
      const responseAddress = await axios.get('https://shawarma.space/api/accounts/user/address/', config);
  ...
  const getFullname = async () => {
    ...
    try {
      const responseFullname = await axios.get('https://shawarma.space/api/accounts/user/fullname/', config);
